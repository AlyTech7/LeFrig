...
export default function ShopsLayout() {
  ...
  return (
    <Stack>
      ...
      <Stack.Screen name="[id]/index" options={{ title: t('layouts.shop'), headerShown: false }} />
      <Stack.Screen name="[id]/products" options={{ title: t('layouts.myProducts'), headerShown: false }} />
